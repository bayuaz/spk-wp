                		...
                		<div class="col-lg-12 mb-4">
                			...
                			<div class="card shadow mb-4">
                				...
                				<form class="form-horizontal" method="post"
                					action="<?= base_url('alternatif/ubah_act') ?>">
                					<div class="card-body">
                						...
                						<div class="form-group row">
                							...
                							<div class="col-sm-4">
                								<input type="text" class="form-control " id="kode"
                									name="kode" value="<?= $detail_alternatif['kode_alternatif'] ?>" autocomplete="off" required>
                							</div>
                						</div>
                						<div class="form-group row">
                							...
                							<div class="col-sm-4">
                								<input type="text" class="form-control " id="nama"
                									name="nama" value="<?= $detail_alternatif['nama_alternatif'] ?>" autocomplete="off" required>
                							</div>
                						</div>
                					</div>
