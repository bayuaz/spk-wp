                		...
                		<div class="col-lg-12 mb-4">
                			...
                			<div class="card shadow mb-4">
                				...
                				<form class="form-horizontal" method="post"
                					action="<?= base_url('kriteria/ubah_act') ?>">
                					<div class="card-body">
                						...
                						<div class="form-group row">
                							...
                							<div class="col-sm-4">
                								<input type="text" class="form-control " id="kode"
                									name="kode" value="<?= $detail_kriteria['kode_kriteria'] ?>" autocomplete="off" required>
                							</div>
                						</div>
                						<div class="form-group row">
                							...
                							<div class="col-sm-4">
                								<input type="text" class="form-control " id="nama"
                									name="nama" value="<?= $detail_kriteria['nama_kriteria'] ?>" autocomplete="off" required>
                							</div>
                						</div>
                						<div class="form-group row">
                						...
                						<div class="form-group row">
                							...
                							<div class="col-sm-4">
                								<input type="number" class="form-control " id="bobot" name="bobot"
                									value="<?= $detail_kriteria['bobot_kriteria'] ?>" autocomplete="off" required>
                							</div>
                						</div>
                					</div>
